     ...
     .controller('adaController', function($http) {
         ...
         vm.questions = [
             ...
             },
             {
                 ...
                 answers: [
                    {
                        text:   'No more than ½ inch high with the top ¼ inch beveled no steeper than 1:2, if the ' +
                                'threshold was installed on or after the 1991 ADA Standards went into effect(1/26/93)?',
                        compliant: true
                    },
                    {
                        text:   'No more than ¾ inch high with the top ½ inch beveled no steeper than 1:2, if the ' +
                                'threshold was installed before the 1991 ADA Standards went into effect (1/26/93)?',
                        compliant: true
                    },
                    {
                        text: 'Not within range',
                        compliant: false
                    }
                 ],
                 helpUrl: '',
